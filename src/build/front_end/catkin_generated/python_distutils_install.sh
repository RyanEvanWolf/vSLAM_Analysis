...
echo_and_run cd "/home/ryan/git/vSLAM_Analysis/src/front_end"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ryan/git/vSLAM_Analysis/src/front_end/setup.py" \
    build --build-base "/home/ryan/git/vSLAM_Analysis/src/build/front_end" \
    install \
    $DESTDIR_ARG \
