...
(cl:defclass <stereoLandmarks> (roslisp-msg-protocol:ros-message)
  ((detID
    :reader detID
    :initarg :detID
    :type cl:string
...
(cl:defclass stereoLandmarks (<stereoLandmarks>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <stereoLandmarks>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'stereoLandmarks)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name front_end-msg:<stereoLandmarks> is deprecated: use front_end-msg:stereoLandmarks instead.")))

(cl:ensure-generic-function 'detID-val :lambda-list '(m))
(cl:defmethod detID-val ((m <stereoLandmarks>))
...
(cl:defmethod descrID-val ((m <stereoLandmarks>))
...
(cl:defmethod leftFeatures-val ((m <stereoLandmarks>))
...
(cl:defmethod leftDescr-val ((m <stereoLandmarks>))
...
(cl:defmethod rightFeatures-val ((m <stereoLandmarks>))
...
(cl:defmethod rightDescr-val ((m <stereoLandmarks>))
...
(cl:defmethod matches-val ((m <stereoLandmarks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader front_end-msg:matches-val is deprecated.  Use front_end-msg:matches instead.")
  (matches m))

(cl:ensure-generic-function 'proc-val :lambda-list '(m))
(cl:defmethod proc-val ((m <stereoLandmarks>))
  ...
  (proc m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <stereoLandmarks>) ostream)
  "Serializes a message object of type '<stereoLandmarks>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <stereoLandmarks>) istream)
  "Deserializes a message object of type '<stereoLandmarks>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<stereoLandmarks>)))
  "Returns string type for a message object of type '<stereoLandmarks>"
  "front_end/stereoLandmarks")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'stereoLandmarks)))
  "Returns string type for a message object of type 'stereoLandmarks"
  "front_end/stereoLandmarks")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<stereoLandmarks>)))
  "Returns md5sum for a message object of type '<stereoLandmarks>"
  "98c12b459ad7d1b907e89d7083880f69")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'stereoLandmarks)))
  "Returns md5sum for a message object of type 'stereoLandmarks"
  "98c12b459ad7d1b907e89d7083880f69")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<stereoLandmarks>)))
  "Returns full string definition for message of type '<stereoLandmarks>"
  (cl:format cl:nil "string detID~%string descrID~%front_end/kPoint[] leftFeatures~%sensor_msgs/Image leftDescr~%front_end/kPoint[] rightFeatures~%sensor_msgs/Image rightDescr~%front_end/cvMatch[] matches~%front_end/ProcTime[] proc~%~%================================================================================~%MSG: front_end/kPoint~%float32 x~%float32 y~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%~%================================================================================~%MSG: sensor_msgs/Image~%# This message contains an uncompressed image~%# (0, 0) is at top-left corner of image~%#~%~%Header header        # Header timestamp should be acquisition time of image~%                     # Header frame_id should be optical frame of camera~%                     # origin of frame should be optical center of cameara~%                     # +x should point to the right in the image~%                     # +y should point down in the image~%                     # +z should point into to plane of the image~%                     # If the frame_id here and the frame_id of the CameraInfo~%                     # message associated with the image conflict~%                     # the behavior is undefined~%~%uint32 height         # image height, that is, number of rows~%uint32 width          # image width, that is, number of columns~%~%# The legal values for encoding are in file src/image_encodings.cpp~%# If you want to standardize a new string format, join~%# ros-users@lists.sourceforge.net and send an email proposing a new encoding.~%~%string encoding       # Encoding of pixels -- channel meaning, ordering, size~%                      # taken from the list of strings in include/sensor_msgs/image_encodings.h~%~%uint8 is_bigendian    # is this data bigendian?~%uint32 step           # Full row length in bytes~%uint8[] data          # actual matrix data, size is (step * rows)~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: front_end/cvMatch~%uint32 queryIdx~%uint32 trainIdx~%uint32 imgIdx~%float32 distance~%~%================================================================================~%MSG: front_end/ProcTime~%string label~%float64 seconds~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'stereoLandmarks)))
  "Returns full string definition for message of type 'stereoLandmarks"
  (cl:format cl:nil "string detID~%string descrID~%front_end/kPoint[] leftFeatures~%sensor_msgs/Image leftDescr~%front_end/kPoint[] rightFeatures~%sensor_msgs/Image rightDescr~%front_end/cvMatch[] matches~%front_end/ProcTime[] proc~%~%================================================================================~%MSG: front_end/kPoint~%float32 x~%float32 y~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%~%================================================================================~%MSG: sensor_msgs/Image~%# This message contains an uncompressed image~%# (0, 0) is at top-left corner of image~%#~%~%Header header        # Header timestamp should be acquisition time of image~%                     # Header frame_id should be optical frame of camera~%                     # origin of frame should be optical center of cameara~%                     # +x should point to the right in the image~%                     # +y should point down in the image~%                     # +z should point into to plane of the image~%                     # If the frame_id here and the frame_id of the CameraInfo~%                     # message associated with the image conflict~%                     # the behavior is undefined~%~%uint32 height         # image height, that is, number of rows~%uint32 width          # image width, that is, number of columns~%~%# The legal values for encoding are in file src/image_encodings.cpp~%# If you want to standardize a new string format, join~%# ros-users@lists.sourceforge.net and send an email proposing a new encoding.~%~%string encoding       # Encoding of pixels -- channel meaning, ordering, size~%                      # taken from the list of strings in include/sensor_msgs/image_encodings.h~%~%uint8 is_bigendian    # is this data bigendian?~%uint32 step           # Full row length in bytes~%uint8[] data          # actual matrix data, size is (step * rows)~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: front_end/cvMatch~%uint32 queryIdx~%uint32 trainIdx~%uint32 imgIdx~%float32 distance~%~%================================================================================~%MSG: front_end/ProcTime~%string label~%float64 seconds~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <stereoLandmarks>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <stereoLandmarks>))
  "Converts a ROS message object to a list"
  (cl:list 'stereoLandmarks
