...
(cl:ensure-generic-function 'detectorName-val :lambda-list '(m))
(cl:defmethod detectorName-val ((m <singleImageDetection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader front_end-srv:detectorName-val is deprecated.  Use front_end-srv:detectorName instead.")
  (detectorName m))

(cl:ensure-generic-function 'det_attrib-val :lambda-list '(m))
(cl:defmethod det_attrib-val ((m <singleImageDetection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader front_end-srv:det_attrib-val is deprecated.  Use front_end-srv:det_attrib instead.")
  (det_attrib m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <singleImageDetection-request>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'detectorName))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'detectorName))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'det_attrib))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <singleImageDetection-request>) istream)
  "Deserializes a message object of type '<singleImageDetection-request>"
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'detectorName) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'detectorName) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'det_attrib) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'det_attrib)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<singleImageDetection-request>)))
  ...
  "48205b8c8040e40e02f025ebed0f5df8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'singleImageDetection-request)))
  "Returns md5sum for a message object of type 'singleImageDetection-request"
  "48205b8c8040e40e02f025ebed0f5df8")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <singleImageDetection-request>))
  ...
  (cl:list 'singleImageDetection-request
    (cl:cons ':detectorName (detectorName msg))
    (cl:cons ':det_attrib (det_attrib msg))
