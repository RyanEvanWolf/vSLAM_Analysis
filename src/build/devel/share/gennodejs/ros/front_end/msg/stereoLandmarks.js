...
class stereoLandmarks {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new stereoLandmarks(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.matches[i] = cvMatch.deserialize(buffer, bufferOffset)
    }
  ...
  static getMessageSize(object) {
    ...
    length += 16 * object.matches.length;
  ...
  static datatype() {
    ...
    return 'front_end/stereoLandmarks';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '98c12b459ad7d1b907e89d7083880f69';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new stereoLandmarks(null);
    ...
    if (msg.matches !== undefined) {
      ...
      for (let i = 0; i < resolved.matches.length; ++i) {
        resolved.matches[i] = cvMatch.Resolve(msg.matches[i]);
      }
    }
    else {
      resolved.matches = []
...
module.exports = stereoLandmarks;
