...
class singleImageDetectionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.det_attrib = null;
      this.returnKP = null;
      this.leftImg = null;
      this.rightImg = null;
    }
    else {
      if (initObj.hasOwnProperty('detectorName')) {
        this.detectorName = initObj.detectorName
      }
      else {
        this.detectorName = '';
      }
      if (initObj.hasOwnProperty('det_attrib')) {
        this.det_attrib = initObj.det_attrib
      }
      else {
        this.det_attrib = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [detectorName]
    bufferOffset = _serializer.string(obj.detectorName, buffer, bufferOffset);
    // Serialize message field [det_attrib]
    bufferOffset = _arraySerializer.string(obj.det_attrib, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [detectorName]
    data.detectorName = _deserializer.string(buffer, bufferOffset);
    // Deserialize message field [det_attrib]
    data.det_attrib = _arrayDeserializer.string(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    let length = 0;
    length += object.detectorName.length;
    object.det_attrib.forEach((val) => {
      length += 4 + val.length;
    });
  ...
  static Resolve(msg) {
    ...
    if (msg.detectorName !== undefined) {
      resolved.detectorName = msg.detectorName;
    }
    else {
      resolved.detectorName = ''
    }

    if (msg.det_attrib !== undefined) {
      resolved.det_attrib = msg.det_attrib;
    }
    else {
      resolved.det_attrib = []
    }
...
module.exports = {
  ...
  md5sum() { return '48205b8c8040e40e02f025ebed0f5df8'; },
