...
"""autogenerated by genpy from front_end/windowStatus.msg. Do not edit."""
import sys
...
class windowStatus(genpy.Message):
  _md5sum = "adb1806280520464955e7665ce04362e"
  _type = "front_end/windowStatus"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """front_end/stereoLandmarks[] msgs
...
sensor_msgs/Image motionInliers"""
  __slots__ = ['msgs','tracks','motion']
  _slot_types = ['front_end/stereoLandmarks[]','front_end/interFrameTracks[]','sensor_msgs/Image[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(windowStatus, self).__init__(*args, **kwds)
